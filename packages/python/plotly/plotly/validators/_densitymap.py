...
class DensitymapValidator(_plotly_utils.basevalidators.CompoundValidator):
    def __init__(self, plotly_name='densitymap',
        ...
        super(DensitymapValidator, self).__init__(plotly_name=plotly_name,
            ...
            below
                Determines if the densitymap trace will be
                inserted before the layer with the specified
                ID. By default, densitymap traces are placed
            ...
            hoverinfosrc
                ...
                for `hoverinfo`.
            hoverlabel
                :class:`plotly.graph_objects.densitymap.Hoverla
            ...
            legendgroup
                ...
                items.
            legendgrouptitle
                :class:`plotly.graph_objects.densitymap.Legendg
            ...
            radius
                ...
                makes the densitymap trace smoother, but less
                detailed.
            radiussrc
                Sets the source reference on Chart Studio Cloud
                for `radius`.

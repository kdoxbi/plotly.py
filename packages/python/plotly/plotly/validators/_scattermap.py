    ...
    def __init__(self, plotly_name='scattermap',
        ...
        super(ScattermapValidator, self).__init__(plotly_name=plotly_name,
            ...
            below
                ...
                specified ID. By default, scattermap layers are
                inserted above all the base layers. To place
                the scattermap layers above every other layer,
                set `below` to "''".
            cluster
            ...
            hoverinfosrc
                ...
                for `hoverinfo`.
            hoverlabel
                :class:`plotly.graph_objects.scattermap.Hoverla
            ...
            legendgroup
                ...
                items.
            legendgrouptitle
                :class:`plotly.graph_objects.scattermap.Legendg
            ...
            line
                :class:`plotly.graph_objects.scattermap.Line`
                instance or dict with compatible properties
            lon
